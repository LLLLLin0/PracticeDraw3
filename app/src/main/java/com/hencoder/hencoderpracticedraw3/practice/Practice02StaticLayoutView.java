...
public class Practice02StaticLayoutView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 以绘制出带有换行的文字StaticLayout layout = StaticLayout.Builder.obtain(text, 0, text.length(), );
        StaticLayout layout = new StaticLayout(text, new TextPaint(textPaint), 500, Layout.Alignment.ALIGN_NORMAL,
                1, 0, true);
        layout.draw(canvas);
